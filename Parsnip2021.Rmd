...
An online mapping portal has been set up for engagement and planning purposes at  
...
## Field Planning 2022  {-}
Georeferenced field maps are presented in `r if(gitbook_on){knitr::asis_output("[here](https://hillcrestgeo.ca/outgoing/fishpassage/projects/parsnip/archive/2022-05-27/) and available for bulk download as [Attachment 1](https://hillcrestgeo.ca/outgoing/fishpassage/projects/parsnip/archive/2022-05-27/parsnip_2022-05-27.zip).")} else knitr::asis_output("[Attachment 1](https://hillcrestgeo.ca/outgoing/fishpassage/projects/parsnip/archive/2022-05-27/parsnip_2022-05-27.zip).")` 

<br>


Planning for potential 2022 field survey sites is presented `r if(gitbook_on){knitr::asis_output("interactively in Figure \\@ref(fig:widget-planning).")}else knitr::asis_output("in Table \\@ref(tab:tab-planning-pdf).")`  
...
xf <- left_join(
  bcfishpass %>% 
    ...
    rowwise() %>% 
    mutate(mapsheet = fpr::fpr_my_mapsheet(wshd = 'parsnip', archive_date = '2022-05-27', site = id),
           mapsheet = paste0("<a href ='", mapsheet,"'target='_blank'>Field Map","</a>")) %>% 
    arrange(id) %>% 
...
caption_text = 'Field planning results to facilitate selection of restoration opportunities for 2022 field surveys.'
...
```{r}
kable(xref_bcfishpass_names_prep)
```
